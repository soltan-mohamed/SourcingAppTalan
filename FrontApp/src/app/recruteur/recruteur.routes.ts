...
import { CandidateHistoryComponent } from './dashboard/candidates/history/candidate-history.component';
import { AddEvaluationComponent } from './dashboard/candidates/addEval/add-evaluation.component';
